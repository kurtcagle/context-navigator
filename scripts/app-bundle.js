  ...
  var App = exports.App = function () {
    ...
    App.prototype.saveCardProperties = function saveCardProperties() {
      ...
      var update = Array.from(Object.keys(this.g[this.context])).forEach(function (predicate) {
        var objects = _this13.g[_this13.context][predicate] || [];
    ...
    App.prototype.refreshTemplateProperties = function refreshTemplateProperties() {
      ...
      window.fetch(path).then(function (response) {
        ...
        _this19.predicates = json.templateData;
        console.log(_this19.predicates);
      }).catch(function (e) {
        return console.log(e);
      });
    };
    ...
    App.prototype.deleteCard = function deleteCard() {
      ...
      if (confirm('Are you sure you wish to delete this item?')) {
        ...
        window.fetch(path).then(function (response) {
          ...
          _this20.refreshApp();
          _this20.fetchContext(landing, "card");
        }).catch(function (err) {
          return console.log(err);
        });
      }
    ...
    App.prototype.processNewCard = function processNewCard() {
      ...
      this.templateProperties.filter(function (predicate) {
        ...
        return _this21.activeCard.predicateEntries.push(Object.assign(predicate, {}));
      });
      ...
      window.fetch(path, { method: "POST", body: JSON.stringify(this.activeCard, null, 4) }).then(function (response) {
        ...
        console.log(_this21.activeCard);

        _this21.fetchContext(_this21.activeCard.curie, 'card');
      }).catch(function (e) {
        return console.log(e);
      });
    };
    ...
    App.prototype.processDuplicateCard = function processDuplicateCard() {
      ...
      var prolog = Object.keys(this.ns).map(function (prefix) {
        return 'prefix ' + prefix + ': <' + _this22.ns[prefix] + '>';
      }).join('\n');
      ...
      Object.keys(this.g[this.context]).forEach(function (predicate) {
        if (!ignorePredicates.has(predicate)) {
          _this22.g[_this22.context][predicate].forEach(function (object) {
            if (object.type === 'literal') {
              triple = _this22.activeCard.curie + ' ' + predicate + ' ' + object.value + '.';
            } else {
              triple = _this22.activeCard.curie + ' ' + predicate + ' """' + object.value + '"""^^' + (object.datatype || 'xsd:string') + '.';
            }
            triples.push(triple);
          });
        }
    ...
    App.prototype.getTerms = function getTerms(property) {
      ...
      window.fetch(path).then(function (response) {
        ...
        _this23.linkPropertyList = {};
        _this23.linkPropertyList[property] = json.results;
      });
      return [];
    };
    ...
    App.prototype.filterComplianceTest = function filterComplianceTest() {
      ...
      window.fetch(path, { method: "POST", body: JSON.stringify(constraintObj, null, 4) }).then(function (response) {
        ...
        _this25.instanceList[classContext] = {};
        _this25.instanceList[classContext][predicate] = json;
      });
    };
    ...
    App.prototype.addProperty = function addProperty(property) {
      ...
      fetch(path).then(function (response) {
        ...
        _this26.availableProperties = json.results;
        console.log(_this26.availableProperties);
        _this26.selectedProperty = property;
        if (property != null) {
          _this26.setPropertyListValue(property);
        };
        _this26.addPropertyModal.open();
      }).catch(function (e) {
        return console.log(e);
      });
    };
    ...
    App.prototype.setPropertyListValue = function setPropertyListValue(predicate) {
      ...
      if (this.activeProperty.nodeKind === 'nodeKind:_IRI') {
        ...
        fetch(path).then(function (response) {
          ...
          _this27.activePropertyValues = json;
        }).catch(function (e) {
          return console.log(e);
        });
      }
    ...
    App.prototype.newConstraint = function newConstraint() {
      ...
      fetch(path).then(function (response) {
        ...
        _this28.activeConstraint.predicate = "";
        _this28.activeConstraint.object = "";
        _this28.addConstraintModal.open();
      }).catch(function (e) {
        return console.log(e);
      });
    };
    ...
    App.prototype.updateInsertImage = function updateInsertImage() {
      ...
      var searchItem = this.searchData.results.find(function (searchItem) {
        return searchItem.s === _this30.insertTermObj.value;
      });
    ...
    App.prototype.deleteClassItems = function deleteClassItems() {
      ...
      if (confirm(message)) {
        ...
        window.fetch(path).then(function (response) {
          ...
          _this31.cache = "refresh";
          _this31.fetchContext("class:_Class", 'card');
        }).catch(function (e) {
          return console.log(e);
        });
      }
    ...
    App.prototype.createImageFile = function createImageFile() {
      ...
      if (url.startsWith('data:image')) {
        ...
        window.fetch(this.server + '/lib/uploadImage.sjs', options).then(function (resp) {
          ...
          var path = _this32.server + '/lib/getImage.sjs?path=' + json.filepath;
          target.image = path;
        }).catch(function (e) {
          return console.log(e);
        });
    ...
    App.prototype.createFile = function createFile() {
      ...
      if (url.startsWith('data:')) {
        ...
        window.fetch(this.server + '/lib/uploadFile.sjs', options).then(function (resp) {
          ...
          var path = _this33.server + '/lib/getFile.sjs?path=' + json.filepath;
    ...
    App.prototype.refreshBlocks = function refreshBlocks() {
      ...
      this.blocks.forEach(function (block) {
        ...
        if (new Set(block.mode).has(_this34.mode)) {
          var container = document.querySelector('.' + block.container);
          if (container != null) {
            ...
            console.log(block);
            if (block.type === "sp") {
              if (_this34.g[_this34.context].hasOwnProperty(block.predicate)) {
                var count = _this34.g[_this34.context][block.predicate].length;
                var index = -1;
                var contexts = _this34.g[_this34.context][block.predicate].map(function (object) {
                  return object.value;
                });
                contexts.forEach(function (context) {
                  window.fetch(_this34.server + '/lib/server.sjs?context=' + context).then(function (response) {
                    return response.json();
                  }).then(function (json) {
            ...
            if (block.type === "self") {
              ...
              if (_this34.g[_this34.context].hasOwnProperty(block.predicate)) {
                console.log(_this34.g[_this34.context][block.predicate]);
                var _count = _this34.g[_this34.context][block.predicate].length;
                var _index = -1;
                var graph = _this34.g;
                var _contexts = _this34.g[_this34.context][block.predicate].map(function (object) {
                  return object.value;
                });
                block.html += _contexts.map(function (context) {
                  return !_this34.isNullLink(context) ? block.template(context, graph, _index, _count) : '';
    ...
    App.prototype.getValidLink = function getValidLink(context, property) {
      ...
      if (this.g[context].hasOwnProperty(property)) {
        var validLink = this.g[context][property].find(function (value) {
          return !_this35.isNullLink(value);
        });
        return validLink;
      } else {
        return false;
    ...
    App.prototype.updateConfiguration = function updateConfiguration() {
      ...
      window.fetch(path).then(function (response) {
        ...
        _this36.config = json;
        _this36.config.mode = _this36.params.mode || _this36.config.mode;
        _this36.context = _this36.params != null ? _this36.params.context || _this36.config.defaultPage : _this36.config.defaultPage;

        _this36.fetchContext(_this36.context, _this36.mode);
      }).catch(function (e) {
        return console.log(e);
      });
    };
      ...
      window.fetch(path).then(function (response) {
        ...
        if (graph.hasOwnProperty('class:_Configuration')) {
          if (graph["class:_Configuration"].hasOwnProperty('class:hasActiveConfiguration')) {
            ...
            if (configuration != _this37.oldConfiguration) {
              _this37.oldConfiguration = configuration;
              var _path2 = _this37.server + '/lib/server.sjs?context=' + configuration;
              window.fetch(_path2).then(function (response) {
                return response.json();
              }).then(function (json) {
                var graph = json.graph;
                _this37.theme = graph[configuration].hasOwnProperty('configuration:hasTheme') ? graph[configuration]['configuration:hasTheme'][0].value : "";
                _this37.defaultLabel = graph[configuration].hasOwnProperty('configuration:hasSiteName') ? graph[configuration]['configuration:hasSiteName'][0].value : "";
                _this37.defaultIcon = graph[configuration].hasOwnProperty('configuration:hasIcon') ? graph[configuration]['configuration:hasIcon'][0].value : "";
                _this37.defaultPage = graph[configuration].hasOwnProperty('configuration:hasHomePage') ? graph[configuration]['configuration:hasHomePage'][0].value : "page:_Home";
                _this37.activeCSS = graph[configuration].hasOwnProperty('configuration:hasCSS') ? graph[configuration]['configuration:hasCSS'][0].value : "";
                _this37.footer = graph[configuration].hasOwnProperty('configuration:hasFooter') ? graph[configuration]['configuration:hasFooter'][0].value : "";
                _this37.topBannerMessage = graph[configuration].hasOwnProperty('configuration:hasTopBanner') ? graph[configuration]['configuration:hasTopBanner'][0].value : "";
                var mode = graph[configuration].hasOwnProperty('configuration:hasMode') ? graph[configuration]['configuration:hasMode'][0].value : "card";
                _this37.mode = _this37.params.mode || mode;
                _this37.context = _this37.params != null ? _this37.params.context || _this37.defaultPage : _this37.defaultPage;

                _this37.fetchContext(_this37.context, _this37.mode);
              }).catch(function (e) {
                return console.log(e);
              });
            }
    ...
    App.prototype.getPreferredClasses = function getPreferredClasses() {
      ...
      if (this.g.hasOwnProperty(context) === null) {
        return [];
      }
    ...
    App.prototype.loadMenu = function loadMenu(context, selector) {
      ...
      window.fetch(path).then(function (response) {
        ...
        var menu = json.data;
        var html = _this38.traverseMenu(menu, context);
        ...
        case "userRole:_DataSteward":
          {
            ...
            this.userValidated = this.loginData.data.hasOwnProperty('user:hasEditClass') ? this.loginData.data['user:hasEditClass'].find(function (editClass) {
              return editClass.value === typeClass || editClass.value === _this40.context;
            }) != null : false;
          };break;
        default:
          this.userValidated = false;
