  ...
  var App = exports.App = function () {
    ...
    App.prototype.filterListPredicates = function filterListPredicates(predicates) {
      return predicates != null ? predicates.filter(function (predicate) {
        return !['rdfs:domain', 'rdfs:range', 'property:hasDomain', 'property:hasRange', 'term:hasPublishingStatus', 'term:hasSourceTerm'].includes(predicate.curie);
      }) : [];
    };
    ...
    App.prototype.addProperty = function addProperty(property) {
      ...
      fetch(path).then(function (response) {
        ...
        _this22.selectedProperty = property;
        if (property != null) {
          _this22.setPropertyListValue(property);
        };
