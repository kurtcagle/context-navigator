...
define('app',['exports', 'aurelia-router', 'aurelia-cookie'], function (exports, _aureliaRouter, _aureliaCookie) {
  ...
  var App = exports.App = function () {
    ...
    App.prototype.fetchContext = function fetchContext(context) {
      ...
      var hash = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "list";
      var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { qRefine: '', noPush: false };
      ...
      window.fetch(this.server + '/lib/server.sjs?context=' + context + '&cache=' + this.cache, options).then(function (blob) {
        ...
        _this3.activePredicates = _this3.filterListPredicates(_this3.predicates);
        var predicate = _this3.activePredicates.length > 0 ? tabIndex ? _this3.activePredicates[tabIndex].curie : _this3.activePredicates[0].curie : 'rdf:type';

        _this3.activateTab(predicate, true, options);
        _this3.qRefine = options.qRefine || "";
        _this3.q = "";
    ...
    App.prototype.filterListPredicates = function filterListPredicates(predicates) {
      var termList = ['rdfs:domain', 'rdfs:range', 'property:hasDomain', 'property:hasRange', 'term:hasPublishingStatus', 'term:hasSourceTerm'];
    ...
    App.prototype.activateTab = function activateTab() {
      var predicate = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'rdf:type';
      ...
      var path = this.server + '/lib/links.sjs?context=' + this.context + '&predicate=' + predicate + '&q=' + this.qRefine + '&page=' + this.page;
    ...
    App.prototype.saveCardProperties = function saveCardProperties() {
      ...
      var update = Array.from(Object.keys(this.g[context])).forEach(function (predicate) {
        Array.from(_this12.g[context][predicate]).forEach(function (object) {
          if (object.type === 'uri') {
    ...
    App.prototype.newCard = function newCard(ctx) {
      ...
      var path = this.server + '/lib/links.sjs?context=class:_Template&constraints=template:hasTarget|' + context;
      window.fetch(path).then(function (response) {
        return response.json();
      }).then(function (json) {
        _this16.availableTemplates = json.data;
      }).catch(function (e) {
        return console.log(e);
      });
      ...
      if (cardType === "class:_Class") {
        ...
        if (confirm('Are you sure you wish to delete this ' + typeLabel.toLowerCase() + '?')) {
          ...
          window.fetch(path).then(function (response) {
            ...
            _this17.fetchContext(cardType, "list");
          }).catch(function (err) {
            return console.log(err);
          });
        }
    ...
    App.prototype.processNewCard = function processNewCard() {
      ...
      window.fetch(path, { method: "POST", body: JSON.stringify(this.activeCard, null, 4) }).then(function (response) {
        ...
        console.log(_this18.activeCard);
        location.href = _this18.client + '?context=' + _this18.activeCard.curie + '&cache=refresh&mode=card';
      }).catch(function (e) {
        return console.log(e);
      });
    };
    ...
    App.prototype.processDuplicateCard = function processDuplicateCard() {
      ...
      var prolog = Object.keys(this.ns).map(function (prefix) {
        return 'prefix ' + prefix + ': <' + _this19.ns[prefix] + '>';
      }).join('\n');
      ...
      Object.keys(this.g[this.context]).forEach(function (predicate) {
        if (!ignorePredicates.has(predicate)) {
          _this19.g[_this19.context][predicate].forEach(function (object) {
            if (object.type === 'literal') {
              triple = _this19.activeCard.curie + ' ' + predicate + ' ' + object.value + '.';
            } else {
              triple = _this19.activeCard.curie + ' ' + predicate + ' """' + object.value + '"""^^' + (object.datatype || 'xsd:string') + '.';
            }
            triples.push(triple);
          });
        }
    ...
    App.prototype.getTerms = function getTerms(property) {
      ...
      window.fetch(path).then(function (response) {
        ...
        _this20.linkPropertyList = {};
        _this20.linkPropertyList[property] = json.results;
      });
      return [];
    };
    ...
    App.prototype.filterComplianceTest = function filterComplianceTest() {
      ...
      window.fetch(path, { method: "POST", body: JSON.stringify(constraintObj, null, 4) }).then(function (response) {
        ...
        _this22.instanceList[classContext] = {};
        _this22.instanceList[classContext][predicate] = json;
      });
    };
    ...
    App.prototype.addProperty = function addProperty(property) {
      ...
      fetch(path).then(function (response) {
        ...
        _this23.availableProperties = json.results;
        _this23.selectedProperty = property;
        if (property != null) {
          _this23.setPropertyListValue(property);
        };
        _this23.addPropertyModal.open();
      }).catch(function (e) {
        return console.log(e);
      });
    };
    ...
    App.prototype.setPropertyListValue = function setPropertyListValue(predicate) {
      ...
      if (this.activeProperty.nodeKind === 'nodeKind:_IRI') {
        ...
        fetch(path).then(function (response) {
          ...
          _this24.activePropertyValues = json;
        }).catch(function (e) {
          return console.log(e);
        });
      }
    ...
    App.prototype.newConstraint = function newConstraint() {
      ...
      fetch(path).then(function (response) {
        ...
        _this25.activeConstraint.predicate = "";
        _this25.activeConstraint.object = "";
        _this25.addConstraintModal.open();
      }).catch(function (e) {
        return console.log(e);
      });
    };
    ...
    App.prototype.updateInsertImage = function updateInsertImage() {
      ...
      var searchItem = this.searchData.results.find(function (searchItem) {
        return searchItem.s === _this27.insertTermObj.value;
      });
    ...
    App.prototype.insertVideo = function insertVideo() {
      var videoEmbed = window.prompt("Enter video Embed Code");
    ...
    App.prototype.deleteClassItems = function deleteClassItems() {
      ...
      if (confirm(message)) {
        ...
        window.fetch(path).then(function (response) {
          ...
          _this28.cache = "refresh";
          _this28.fetchContext("class:_Class", 'list');
        }).catch(function (e) {
          return console.log(e);
        });
      }
    ...
    App.prototype.createImageFile = function createImageFile() {
      ...
      if (url.startsWith('data:image')) {
        ...
        window.fetch(this.server + '/lib/uploadImage.sjs', options).then(function (resp) {
          ...
          var path = _this29.server + '/lib/getImage.sjs?path=' + json.filepath;
          target.image = path;
        }).catch(function (e) {
          return console.log(e);
        });
    ...
    App.prototype.refreshBlocks = function refreshBlocks() {
      ...
      this.blocks.forEach(function (block) {
        ...
        if (new Set(block.mode).has(_this30.mode)) {
          var container = document.querySelector('.' + block.container);
          if (container != null) {
            ...
            console.log(block);
            if (block.type === "sp") {
              if (_this30.g[_this30.context].hasOwnProperty(block.predicate)) {
                var count = _this30.g[_this30.context][block.predicate].length;
                var index = -1;
                var contexts = _this30.g[_this30.context][block.predicate].map(function (object) {
                  return object.value;
                });
                contexts.forEach(function (context) {
                  window.fetch(_this30.server + '/lib/server.sjs?context=' + context).then(function (response) {
                    return response.json();
                  }).then(function (json) {
            ...
            if (block.type === "self") {
              ...
              if (_this30.g[_this30.context].hasOwnProperty(block.predicate)) {
                console.log(_this30.g[_this30.context][block.predicate]);
                var _count = _this30.g[_this30.context][block.predicate].length;
                var _index = -1;
                var graph = _this30.g;
                var _contexts = _this30.g[_this30.context][block.predicate].map(function (object) {
                  return object.value;
                });
                block.html += _contexts.map(function (context) {
                  return !_this30.isNullLink(context) ? block.template(context, graph, _index, _count) : '';
    ...
    App.prototype.getValidLink = function getValidLink(context, property) {
      ...
      if (this.g[context].hasOwnProperty(property)) {
        var validLink = this.g[context][property].find(function (value) {
          return !_this31.isNullLink(value);
        });
        return validLink;
      } else {
        return false;
      ...
      window.fetch(path).then(function (response) {
        ...
        if (graph.hasOwnProperty('class:_Configuration')) {
          if (graph["class:_Configuration"].hasOwnProperty('class:hasActiveConfiguration')) {
            ...
            if (configuration != _this32.oldConfiguration) {
              _this32.oldConfiguration = configuration;
              var _path2 = _this32.server + '/lib/server.sjs?context=' + configuration;
              window.fetch(_path2).then(function (response) {
                return response.json();
              }).then(function (json) {
                var graph = json.graph;
                _this32.theme = graph[configuration].hasOwnProperty('configuration:hasTheme') ? graph[configuration]['configuration:hasTheme'][0].value : "";
                _this32.defaultLabel = graph[configuration].hasOwnProperty('configuration:hasSiteName') ? graph[configuration]['configuration:hasSiteName'][0].value : "";
                _this32.defaultIcon = graph[configuration].hasOwnProperty('configuration:hasIcon') ? graph[configuration]['configuration:hasIcon'][0].value : "";
                _this32.defaultPage = graph[configuration].hasOwnProperty('configuration:hasHomePage') ? graph[configuration]['configuration:hasHomePage'][0].value : "page:_Home";
                var mode = graph[configuration].hasOwnProperty('configuration:hasMode') ? graph[configuration]['configuration:hasMode'][0].value : "list";
                _this32.mode = _this32.params.mode || mode;
                _this32.context = _this32.params != null ? _this32.params.context || _this32.defaultPage : _this32.defaultPage;

                _this32.fetchContext(_this32.context, _this32.mode);
              }).catch(function (e) {
                return console.log(e);
              });
            }
