...
define('app',['exports', 'aurelia-router', 'aurelia-cookie'], function (exports, _aureliaRouter, _aureliaCookie) {
  ...
  var App = exports.App = function () {
    function App() {
      ...
      this.sortModeStates = [{ label: "Date Descending", value: "dateDesc" }, { label: "Alphanumeric", value: "alpha" }];
      this.namespace = '';
    ...
    App.prototype.insertTerm = function insertTerm(searchItem) {
      ...
      this.q = "";
      var label = this.insertTermLabel != "" ? this.insertTermLabel : searchItem.p;
      var link = '<a href="/?context=' + searchItem.s + '" class="link">' + label + '</a>';
      var editor = document.querySelector('.bodyEditor');
      var html = editor.innerHTML;
