...
define('app',['exports', 'aurelia-router', 'aurelia-cookie'], function (exports, _aureliaRouter, _aureliaCookie) {
  ...
  var App = exports.App = function () {
    function App() {
      ...
      this.sortModeStates = [{ label: "Created Date Descending", value: "createdDateDesc" }, { label: "Modified Date Descending", value: "modifiedDateDesc" }, { label: "Alphanumeric", value: "alpha" }, { label: "Internal Order", value: "ordinal" }];
      this.namespace = '';
