    ...
    App.prototype.refreshBlocks = function refreshBlocks() {
      ...
      this.blocks.forEach(function (block) {
        ...
        if (container != null) {
          ...
          console.log(block);
          if (block.type === "sp") {
            if (_this28.g[_this28.context].hasOwnProperty(block.predicate)) {
              var count = _this28.g[_this28.context][block.predicate].length;
              var index = -1;
              var contexts = _this28.g[_this28.context][block.predicate].map(function (object) {
                return object.value;
              });
              contexts.forEach(function (context) {
                window.fetch(_this28.server + '/lib/server.sjs?context=' + context).then(function (response) {
                  return response.json();
                }).then(function (json) {
          ...
          if (block.type === "self") {
            ...
            if (_this28.g[_this28.context].hasOwnProperty(block.predicate)) {
              console.log(_this28.g[_this28.context][block.predicate]);
              var _count = _this28.g[_this28.context][block.predicate].length;
              var _index = -1;
              var graph = _this28.g;
              var _contexts = _this28.g[_this28.context][block.predicate].map(function (object) {
                return object.value;
              });
              block.html += _contexts.map(function (context) {
                return !_this28.isNullLink(context) ? block.template(context, graph, _index, _count) : '';
    ...
    App.prototype.getValidLink = function getValidLink(context, property) {
      ...
      if (this.g[context].hasOwnProperty(property)) {
        var validLink = this.g[context][property].find(function (value) {
          return !_this29.isNullLink(value);
        });
        return validLink;
      } else {
        return false;
