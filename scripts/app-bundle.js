...
define('app',['exports', 'aurelia-router', 'aurelia-cookie'], function (exports, _aureliaRouter, _aureliaCookie) {
  ...
  var App = exports.App = function () {
    function App() {
      ...
      this.sortModeStates = [{ label: "Created Date Descending", value: "createdDateDesc" }, { label: "Modified Date Descending", value: "modifiedDateDesc" }, { label: "Alphanumeric Ascending", value: "alphaAsc" }, { label: "Alphanumeric Descending", value: "alphaDesc" }, { label: "Internal Order Ascending", value: "ordinalAsc" }, { label: "Internal Order Descending", value: "ordinalDesc" }];
      this.namespace = '';
    ...
    App.prototype.filterListPredicates = function filterListPredicates(predicates) {
      return predicates != null ? predicates.filter(function (predicate) {
        return !['rdfs:domain', 'rdfs:range', 'property:hasDomain', 'property:hasRange'].includes(predicate.curie);
      }) : [];
    };
